...
export DOKKU_REPO=${DOKKU_REPO:-"https://github.com/jro7/dokku-debian.git"}
...
[[ `lsb_release -sr` == "12.04" || `lsb_release -si` == "Debian" ]] && apt-get install -y python-software-properties
